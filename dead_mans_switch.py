...
class EmailServer:
    ...
    Supports major email providers with automatic SMTP configuration including:
    Gmail, iCloud, Outlook, Yahoo, Hotmail, ProtonMail, Fastmail, Zoho, AOL,
    GMX, Mail.com, and Yandex. Can be used as a context manager for connection management.
